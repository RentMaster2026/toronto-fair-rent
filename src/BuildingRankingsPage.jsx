...
function buildingHoodsFor(hoodKey) {
  return Object.entries(TORONTO_NEIGHBOURHOODS)
...
const CITY_FAQS = [
  ...
  },
  {
    ...
    a: "Yes. We do not punish a building just because it is expensive. A luxury building in Yorkville can still score well if its rent is fair compared to similar luxury buildings in the same neighbourhood. The score compares apples to apples, not luxury buildings to student apartments.",
  },
  {
        ...
        <div className="br-wrap">
          ...
          <section className="br-hero">
            ...
            <p style={{ fontSize:12, color:"var(--t3)", lineHeight:1.6 }}>
              {scoresReady
                ? `Search across ${totalBuildings} rental building${totalBuildings !== 1 ? "s" : ""} ${isHoodPage ? `in ${hood.name}` : "in Toronto"}. Scores improve as renters submit data.`
          ...
          <section className="br-section" id="rankings">
            ...
            <h2 className="br-h2">
              {isHoodPage
                ...
                : "Search Toronto rental buildings"}
            </h2>
                ...
                <>
                  <div className="results-meta">
                    {trimmed
                      ...
                      : `Top ${results.length} ${isHoodPage ? hood.name : "Toronto"} building${results.length === 1 ? "" : "s"}`}
                  </div>
                  <div className="buildings-grid">
                    {results.map(b => {
                      const key = b.address ? `${b.name} - ${b.address}` : b.name;
                      const subs = buildingScores[key] || [];
                      const bHood = TORONTO_NEIGHBOURHOODS[b.neighbourhood];
            ...
            <section className="br-section">
              ...
              <div className="br-body">
                <p>
                  ...
                  typically run well above the city average. Scarborough, Etobicoke, and East York offer more
