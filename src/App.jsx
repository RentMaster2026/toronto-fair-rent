...
const MARKET_SNAPSHOT = [
  {label:"1-bedroom average",  val:"$2,650/mo"},
  {label:"2-bedroom average",  val:"$3,440/mo"},
  {label:"Vacancy rate (2025)", val:"1.7%"},
  {label:"Highest neighbourhood", val:"Rosedale (+35%)"},
  {label:"Most affordable",    val:"Scarborough (-18%)"},
