...
export default function App() {
  ...
  function getShareText() {
    ...
    return `Toronto Rent Check: ${result.todayPct > 0 ? "+" : ""}${result.todayPct}% vs market for a ${u} in ${neighborhood}. torontofairrent.ca`;
  }
    ...
    <div style={{ minHeight: "100vh", background: "#f8fafc", fontFamily: "'Inter', -apple-system, BlinkMacSystemFont, sans-serif", color: "#0f172a" }}>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .option-btn.selected { border-color: #3b82f6; background: #3b82f615; color: #2563eb; font-weight: 600; }
          ...
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: "16px 0", gap: 16 }}>
            <div>
              <div style={{ display: "flex", alignItems: "center", gap: 9, marginBottom: 3 }}>
                <a href="https://fairrent.ca" style={{ textDecoration: "none", display: "flex", alignItems: "center", justifyContent: "center", width: 26, height: 26, background: "#3b82f6", borderRadius: 6, fontSize: 11, fontWeight: 800, color: "#0f172a", flexShrink: 0 }}>FR</a>
                <span style={{ fontSize: 17, fontWeight: 700, color: "#fff", letterSpacing: "-.02em" }}>Toronto Rent Calculator</span>
              </div>
              <p style={{ fontSize: 12, color: "#64748b" }}>Free · anonymous · no account needed</p>
            </div>
            <div style={{ textAlign: "right", flexShrink: 0 }}>
              <div style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 20, fontWeight: 500, color: "#3b82f6", lineHeight: 1 }}>
              ...
              {neighborhood && unitType && smartBenchmark != null && (
                <div style={{ padding: "10px 14px", background: "#f8fafc", border: "1px solid #e2e8f0", borderRadius: 8, display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: 8 }}>
                  <span style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 11, color: "#64748b" }}>
                    Toronto benchmark — {neighborhood}
                  </span>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
            ...
            <div className={revealed ? "fade-in d1" : ""} style={{ background: verdict.bg, border: `1.5px solid ${verdict.border}`, borderRadius: 12, padding: "24px 22px 20px" }}>
              ...
              <div style={{ marginTop: 12, display: "flex", alignItems: "center", gap: 6 }}>
                ...
                <span style={{ padding: "1px 7px", background: result.benchSource === "baseline" ? "#f1f5f9" : "#3b82f618", border: `1px solid ${result.benchSource === "baseline" ? "#e2e8f0" : "#3b82f640"}`, borderRadius: 100, fontFamily: "'JetBrains Mono', monospace", fontSize: 9, color: result.benchSource === "baseline" ? "#94a3b8" : "#2563eb", textTransform: "uppercase", letterSpacing: ".05em" }}>
