...
export default function App() {
  ...
  function getShareText() {
    ...
    return `Toronto Rent Calculator: I'm paying ${result.todayPct > 0 ? "+" : ""}${result.todayPct}% vs market for a ${unit} in ${form.neighborhood}. torontofairrent.ca`;
  }
      ...
      <main style={{ maxWidth: 680, margin: "0 auto", padding: "32px 20px 80px" }}>
        ...
        <div style={{ marginTop: 36, padding: "20px 0", borderTop: "1px solid #e2e8f0" }}>
          ...
          <p style={{ marginTop: 12, fontSize: 11, color: "#94a3b8", lineHeight: 1.7 }}>
            Benchmarks use neighbourhood-level multipliers applied to Toronto-wide averages. Accuracy improves as community submissions grow. Not legal or financial advice.
          </p>
        </div>
      </main>
    </div>
