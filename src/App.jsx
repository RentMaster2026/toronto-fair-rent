...
const HOOD_MULTIPLIERS = {
    ...
    "Greektown": 1.02,
    "Junction": 0.97,
    "Kensington Market": 0.96,
    "Lawrence Park": 1.25,
    "Leaside": 1.14,
    "Leslieville": 1.04,
    "Liberty Village": 1.12,
    "Little Italy": 1.05,
    "Midtown": 1.07,
    "North York": 0.9,
    "Parkdale": 0.93,
...
function getInsight(pct, moveInYear) {
  ...
  if (pct >= -5)  return { head: "You're at market rate.", body: "Your rent aligns with Toronto averages for this unit and neighbourhood — a useful baseline heading into your next renewal conversation.", link: null };
  ...
  return { head: "You have a strong deal.", body: "You're well below today's Toronto market. Protect this tenancy — voluntary moves reset your rent to current market rates.", link: { t: "Before You Move: Know Your Rights →", u: "https://www.ontario.ca/page/renting-ontario-your-rights" } };
}
...
export default function App() {
  ...
  function getShareText() {
    ...
    return `Toronto Rent Calculator: I'm paying ${result.todayPct > 0 ? "+" : ""}${result.todayPct}% vs market for a ${unit} in ${form.neighborhood}. https://torontofairrent.ca`;
  }
          ...
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: "18px 0", gap: 16 }}>
            <div>
              ...
              <p style={{ fontSize: 12, color: "#64748b", margin: 0 }}>
                See if your Toronto rent is fair — free, anonymous, no account needed
              </p>
            </div>
            <div style={{ textAlign: "right", flexShrink: 0 }}>
              <div style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 22, fontWeight: 500, color: "#3b82f6", lineHeight: 1 }}>
          ...
          <div style={{ background: "#fff", borderRadius: 12, border: "1px solid #e2e8f0", boxShadow: "0 1px 3px rgba(0,0,0,.06)", overflow: "hidden" }}>
            ...
            <div style={{ padding: "22px 24px 20px", borderBottom: "1px solid #f1f5f9" }}>
              <h1 style={{ fontSize: 20, fontWeight: 800, color: "#0f172a", letterSpacing: "-.02em", marginBottom: 6 }}>
                Compare your Toronto rent to market rates
              </h1>
              <p style={{ fontSize: 13, color: "#64748b", lineHeight: 1.6 }}>
                Based on CMHC and Rentals.ca data for Toronto. Your submission improves accuracy for everyone.
              </p>
            </div>
              ...
              {form.neighborhood && form.unitType && smartBenchmark != null && (
                <div style={{ padding: "10px 14px", background: "#f8fafc", border: "1px solid #e2e8f0", borderRadius: 8, display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: 8 }}>
                  ...
                  <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                    ...
                    <span style={{ padding: "2px 8px", background: benchSource === "baseline" ? "#f1f5f9" : "#3b82f620", border: `1px solid ${benchSource === "baseline" ? "#e2e8f0" : "#3b82f650"}`, borderRadius: 100, fontFamily: "'JetBrains Mono', monospace", fontSize: 9, color: benchSource === "baseline" ? "#94a3b8" : "#2563eb", textTransform: "uppercase", letterSpacing: ".06em" }}>
                      {benchLabel}
                    </span>
                  </div>
                </div>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
            ...
            <div className={revealed ? "fade-in d1" : ""} style={{ background: verdict.bg, border: `1.5px solid ${verdict.border}`, borderRadius: 12, padding: "28px 24px 22px" }}>
              ...
              <div style={{ marginTop: 14, display: "flex", alignItems: "center", gap: 6 }}>
                ...
                <span style={{ padding: "2px 8px", background: result.benchSource === "baseline" ? "#f1f5f9" : "#3b82f620", border: `1px solid ${result.benchSource === "baseline" ? "#e2e8f0" : "#3b82f650"}`, borderRadius: 100, fontFamily: "'JetBrains Mono', monospace", fontSize: 9, color: result.benchSource === "baseline" ? "#94a3b8" : "#2563eb", textTransform: "uppercase", letterSpacing: ".06em" }}>
            ...
            {shareOpen && (
              <div className="fade-in" style={{ background: "#fff", border: "1px solid #e2e8f0", borderRadius: 10, padding: "16px 18px" }}>
                ...
                <div className="grid-share" style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr 1fr", gap: 8 }}>
                  <a className="share-btn" href={`https://www.reddit.com/submit?url=https://torontofairrent.ca&title=${encodeURIComponent(getShareText())}`} target="_blank" rel="noopener noreferrer" style={{ background: "#ff4500", color: "#fff" }}>Reddit</a>
                  ...
                  {navigator.share ? (
                    <button className="share-btn" onClick={() => navigator.share({ title: "Toronto Rent Calculator", text: getShareText(), url: "https://torontofairrent.ca" }).catch(() => {})} style={{ background: "#0f172a", color: "#fff" }}>More ↗</button>
                  ) : (
